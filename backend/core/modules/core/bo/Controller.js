...
/**
 * Clase del Core de Controller transversal a la aplicación
 * @author Andres Felipe Ardila Rivas <felipeardila1010@gmail.com>
 * @copyright Andres Felipe Ardila Rivas 2018
 */
class Controller extends global.app.core.classes.Core{
    ...
    constructor(filename) {
        super(filename);
        global.app.core.classes.Controller = Controller;
    }
}
